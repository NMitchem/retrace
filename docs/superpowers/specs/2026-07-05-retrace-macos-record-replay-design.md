...
> only for brevity; the dependency ordering is otherwise unchanged. M2 itself later grew four
...
> servicing, `2026-07-07-retrace-m2-mach-design.md`), **M2-va47** (47-bit guest VA,
> `2026-07-10-retrace-m2-va47-design.md`), and **M2-bfam** (objc B-family PAC,
> `2026-07-10-retrace-m2-bfam-design.md`) — without renumbering M3–M6.
